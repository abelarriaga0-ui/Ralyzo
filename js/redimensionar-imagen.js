...
async function runTool(){
  ...
  statusText.textContent = "Redimensionando imagen...";
  ...
  try{
    ...
    canvas.toBlob((blob)=>{
      ...
      resultMeta.innerHTML = `
        ...
        Resolución: ${newWidth} × ${newHeight}
      `;

      downloadLink.href = url;
      downloadLink.download = "ralyzo-redimensionada.png";
      downloadLink.textContent = "Descargar imagen";

      resultSection.style.display = "grid";
      statusText.textContent = "Imagen redimensionada.";
      runBtn.disabled = false;
    },"image/png");
  }catch(e){
    statusText.textContent = "Error al redimensionar la imagen.";
    runBtn.disabled = false;
  }
}
